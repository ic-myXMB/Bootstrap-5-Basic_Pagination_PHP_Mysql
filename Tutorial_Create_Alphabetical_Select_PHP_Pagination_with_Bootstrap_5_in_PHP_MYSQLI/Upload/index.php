    ...
    <head>
      ...
      <body>  
           <div class="container mt-5"> 
                <h4 class="mb-3" align="center"><i class="fa-solid fa-code"></i> Tutorial | Create Alphabetic Pagination (Select) in Bootstrap 5 with PHP & MYSQLI</h4>
                ...
                <!-- Breadcrumb -->
                <ol class="breadcrumb mb-1 mt-4 p-2 bg-light border border-default rounded-3">
